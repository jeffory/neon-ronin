...
**Art direction:** Dark cyberpunk Tokyo at night. Narrow alleyways flanked by tall buildings with glowing neon signs in Japanese characters. Dominant palette: vivid pink, magenta, cyan, and purple neon against dark steel and concrete. Wet asphalt streets reflecting neon light. Dense atmospheric haze with volumetric glow. Futuristic but gritty — exposed wiring, vending machines, cluttered signage. Weapons have a sleek sci-fi aesthetic with cyan/teal accents and subtle emissive details. HUD is minimal and clean with a tech/holographic feel.

## 3D Models

| Name | Description | Size | Image | GLB |
|------|-------------|------|-------|-----|
| handgun | Sleek sci-fi pistol with teal LED accents | 0.3m long | assets/img/handgun.png | assets/glb/handgun.glb |
| rifle | Futuristic assault rifle with holographic sight | 0.7m long | assets/img/rifle.png | assets/glb/rifle.glb |
| shotgun | Heavy sci-fi shotgun with orange warning stripes | 0.8m long | assets/img/shotgun.png | assets/glb/shotgun.glb |
...
|------|-------------|------|-------|
| neon_sign_1 | Pink/magenta Japanese kanji neon sign | 1m x 0.5m | assets/img/neon_sign_1.png |
| neon_sign_2 | Cyan/blue Japanese katakana neon sign | 1m x 0.5m | assets/img/neon_sign_2.png |
...
| Name | Description | Size | Image |
|------|-------------|------|-------|
| night_sky | Dark cyberpunk night sky with neon-lit clouds | 2560x1440, skybox | assets/img/night_sky.png |
